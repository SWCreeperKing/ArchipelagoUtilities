...
namespace KaitoKid.ArchipelagoUtilities.Net.Client.ConnectionResults
{
    internal class TooUpdatedClientConnectionResult : ClientVersionMismatchConnectionResult
    {
        ...
        public TooUpdatedClientConnectionResult(string errorMessage, string clientName, string currentVersion, string expectedVersion) : base(errorMessage, currentVersion, expectedVersion)
        {
        }
    }
}